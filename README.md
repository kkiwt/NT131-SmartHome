...
-Mục tiêu của đồ án
+Thiết kế và xây dựng một hệ thống nhúng kết nối mạng
+Thu thập dữ liệu từ các cảm biến môi trường
+Cho phép điều khiển thiết bị từ xa
+Triển khai truyền dữ liệu thời gian thực
+Xây dựng mô hình nhà thông minh để minh họa hệ thống
